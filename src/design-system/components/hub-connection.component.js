...
import { t as J } from "../chunks/custom-element.ttkHUa8w.js";
...
async function z(s, e, t, n, o, r) {
  const c = {}, [a, l] = I();
  c[a] = l, s.log(i.Trace, `(${e} transport) sending data. ${P(o, r.logMessageContent)}.`);
...
function te(s) {
  return s === void 0 ? new D(i.Information) : s === null ? T.instance : s.log !== void 0 ? s : new D(s);
}
class ne {
  constructor(e, t) {
...
class de {
  ...
  subscribe(e) {
    return this.observers.push(e), new ne(this, e);
  }
}
class ge {
  constructor(e, t, n) {
...
const fe = 30 * 1e3, pe = 15 * 1e3, me = 1e5;
var g;
(function(s) {
  ...
  async connect(e, t) {
    ...
    return this._accessTokenFactory && (n = await this._accessTokenFactory()), new Promise((o, r) => {
      ...
      if (_.isNode || _.isReactNative) {
        const u = {}, [d, C] = I();
        u[d] = C, n && (u[k.Authorization] = `Bearer ${n}`), a && (u[k.Cookie] = a), c = new this._webSocketConstructor(e, void 0, {
...
class ve {
  constructor(e, t = {}) {
    ...
    }, this.features = {}, this._negotiateVersion = 1, p.isRequired(e, "url"), this._logger = te(t.logger), this.baseUrl = this._resolveUrl(e), t = t || {}, t.logMessageContent = t.logMessageContent === void 0 ? !1 : t.logMessageContent, typeof t.withCredentials == "boolean" || t.withCredentials === void 0)
  ...
  async _createTransport(e, t, n, o) {
    ...
    for (const u of a) {
      ...
      if (d instanceof Error)
        ...
        try {
          ...
          if (this._logger.log(i.Error, `Failed to start the transport '${u.transport}': ${C}`), l = void 0, c.push(new Q(`${u.transport} failed: ${C}`, f[u.transport])), this._connectionState !== "Connecting") {
    ...
    return c.length > 0 ? Promise.reject(new Y(`Unable to connect to the server with any of the available transports. ${c.join(" ")}`, c)) : Promise.reject(new Error("None of the transports supported by the client are supported by the server."));
  }
...
class N {
  constructor(e) {
    this._transport = e, this._buffer = [], this._executing = !0, this._sendBufferedData = new $(), this._transportResult = new $(), this._sendLoopPromise = this._sendLoop();
  }
  send(e) {
    return this._bufferData(e), this._transportResult || (this._transportResult = new $()), this._transportResult.promise;
  }
  stop() {
...
class Ie {
  constructor() {
    this.name = Ee, this.version = 2, this.transferFormat = m.Text;
  }
...
class Re {
  ...
  withUrl(e, t) {
    return p.isRequired(e, "url"), p.isNotEmpty(e, "url"), this.url = e, typeof t == "object" ? this.httpConnectionOptions = { ...this.httpConnectionOptions, ...t } : this.httpConnectionOptions = {
   ...
   */
  withHubProtocol(e) {
    return p.isRequired(e, "protocol"), this.protocol = e, this;
  }
   ...
   */
  withServerTimeout(e) {
    return p.isRequired(e, "milliseconds"), this._serverTimeoutInMilliseconds = e, this;
  }
  ...
  withKeepAliveInterval(e) {
    return p.isRequired(e, "milliseconds"), this._keepAliveIntervalInMilliseconds = e, this;
  }
  ...
  build() {
    ...
    const t = new ve(this.url, e);
    return H.create(t, this.logger || T.instance, this.protocol || new Ie(), this.reconnectPolicy, this._serverTimeoutInMilliseconds, this._keepAliveIntervalInMilliseconds, this._statefulReconnectBufferSize);
  }
}
function $e(s) {
  return s.log !== void 0;
}
var De = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, y = (s, e, t, n) => {
...
let S = class extends K {
  constructor() {
    super(...arguments), this.connection = null, this.watchedMethods = /* @__PURE__ */ new Set(), this.baseUrl = "", this.keepAliveIntervalInMilliseconds = 15e3, this.skipNegotiation = !1, this.transport = f.None, this.connectMode = "manual", this.emitEvent = (s, e) => {
      this.emit(s, {
        detail: {
          args: e
        }
  ...
  connectedCallback() {
    ...
    this.addEventListener = (e, t, ...n) => {
      var c;
      const [o, r] = e.split(".");
      o === "cx-invoked" && (this.watchedMethods.add(r), (c = this.connection) == null || c.on(r, (...a) => {
        this.emitEvent(`cx-invoked.${r}`, a);
      })), s.call(this, e, t, ...n);
  ...
  registerEventListeners() {
    this.connection && this.watchedMethods.forEach((s) => {
      var e;
      (e = this.connection) == null || e.on(
        s,
        (...t) => this.emitEvent(`cx-invoked.${s}`, t)
      );
    });
  }
  onBaseUrlChanged() {
  ...
  async start() {
    ...
    }).withKeepAliveInterval(this.keepAliveIntervalInMilliseconds).build(), this.registerEventListeners(), await this.connection.start());
  }
  /** Stops the connection.
  ...
  async stop() {
    var s;
    if (!this.connection || ((s = this.connection) == null ? void 0 : s.state) === g.Disconnected)
