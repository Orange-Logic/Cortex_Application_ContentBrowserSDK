...
import { i as h, x as i } from "../chunks/lit-element.DRlPF2me.js";
...
`;
var v = Object.defineProperty, x = Object.getOwnPropertyDescriptor, t = (l, f, r, a) => {
  for (var o = a > 1 ? void 0 : a ? x(f, r) : f, c = l.length - 1, b; c >= 0; c--)
    (b = l[c]) && (o = (a ? b(f, r, o) : b(o)) || o);
  return a && o && v(f, r, o), o;
};
const d = {
  ...
  async checkFontLoaded() {
    ...
    for (const f of document.fonts)
      f.family.replace(/['"]/g, "") === d[this.variant] && (this.fontLoaded = !0);
  }
  handleLabelChange() {
    typeof this.label == "string" && this.label.length > 0 ? (this.setAttribute("role", "img"), this.setAttribute("aria-label", this.label), this.removeAttribute("aria-hidden")) : (this.removeAttribute("role"), this.removeAttribute("aria-label"), this.setAttribute("aria-hidden", "true"));
  }
  render() {
    return this.src ? i`<span class="custom-icon" part="span"
        ><img src=${this.src}
...
], e.prototype, "iconClass", 2);
t([
  g()
], e.prototype, "fontLoaded", 2);
t([
  u("label")
], e.prototype, "handleLabelChange", 1);
export {
  e as default
};
