import './dam-view-asset-version-history';
...
import type CxDamViewAssetVersionHistory from './dam-view-asset-version-history';
...
describe('dam-view-asset-version-history', () => {
  it('shows a spinner while loading', async () => {
    const el = await fixture<CxDamViewAssetVersionHistory>(html`
      <cx-dam-view-asset-version-history ?loading=${true}></cx-dam-view-asset-version-history>
    `);
  ...
  it('renders an empty menu when there are no versions', async () => {
    const el = await fixture<CxDamViewAssetVersionHistory>(html`
      <cx-dam-view-asset-version-history .versions=${[]}></cx-dam-view-asset-version-history>
    `);
    await elementUpdated(el);
  ...
  describe('with versions', () => {
    it('renders each version as a readonly menu row with grid layout', async () => {
      ...
      const el = await fixture<CxDamViewAssetVersionHistory>(html`
        <cx-dam-view-asset-version-history .versions=${[v1, v2]}></cx-dam-view-asset-version-history>
      `);
      await elementUpdated(el);
      const items = el.shadowRoot!.querySelectorAll(
        'cx-menu.dam-view-asset-version-history__menu cx-menu-item',
      );
    ...
    it('shows version label, file name, author email, and date prefix', async () => {
      ...
      const el = await fixture<CxDamViewAssetVersionHistory>(html`
        <cx-dam-view-asset-version-history .versions=${[v]}></cx-dam-view-asset-version-history>
      `);
      await elementUpdated(el);
    ...
    it('marks only the first row as current version', async () => {
      ...
      const latest = el.shadowRoot!.querySelectorAll(
        '.dam-view-asset-version-history__menu-item__latest',
      );
