...
import { ChangeOption, Facet, OptionType } from '@/types/dam-view';
...
import CxDamViewControlFilterFacet from '../dam-view-control-filter-facet/dam-view-control-filter-facet';
import styles from './dam-view-control-filter.styles';
 ...
 *
 * @event cx-dam-view-control-filter-change - Fired when the filters are changed.
 */
@customElement('cx-dam-view-control-filter')
export default class CxDamViewControlFilter extends CortexElement {
  static readonly styles: CSSResultGroup = [componentStyles, styles];

  static readonly dependencies = {
    'cx-badge': CxBadge,
    'cx-button': CxButton,
    'cx-dam-view-control-filter-facet': CxDamViewControlFilterFacet,
  ...
  private handleClearAllClick() {
    this.emit('cx-dam-view-control-filter-change', {
      detail: {
        selection: {},
      },
    });
          ...
          () => html`<div>
            ${repeat(this.availableFacets,
              ...
              (availableFacet) => {
                ...
                return html`
                  <cx-dam-view-control-filter-facet
