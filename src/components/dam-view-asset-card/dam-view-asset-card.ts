...
import styles from './dam-view-asset-card.styles';

@customElement('dam-view-asset-card')
export default class CxDamViewAssetCard extends CortexElement {
  ...
  render() {
    return html`
      <cx-card
        class=${classMap({
          'dam-view-asset-card': true,
          [`dam-view-asset-card--${this.view}`]: true,
          'dam-view-asset-card--disabled': this.inColdStorage,
          'dam-view-asset-card--selected': this.selected,
        })}
        interactive
      >
        ...
        ></cx-dam-view-asset-preview>
        <cx-space spacing="small" align-items="center" wrap="nowrap" class="dam-view-asset-card__info">
          ${when(
            this.showTitle && this.assetName,
            () => html`
              <cx-line-clamp lines="1" class="dam-view-asset-card__name">
            ...
            `,
            () => html`
              <cx-typography variant="small" class="dam-view-asset-card__placeholder">
                <span>empty</span>
              </cx-typography>
            `,
          )}
        ...
        ${when(
          this.selected,
          () => html`
            <div slot="image" class="dam-view-asset-card__checkbox">
        ...
        ${when(
          ...
          () => html`
            <cx-array-line-clamp
              class="dam-view-asset-card__tags"
              separator=" "
              tooltip-separator=", "
            >
              ${repeat(
              ...
              ${when(
                ...
                () => html`
                  <cx-line-clamp
                    lines="1"
                    class=${classMap({
                      'dam-view-asset-card__name': true,
                      'dam-view-asset-card__name--right': true,
                    })}
                  >
                    <cx-typography variant="small">
                      ${this.assetSize}
...
declare global {
  interface HTMLElementTagNameMap {
    'dam-view-asset-card': CxDamViewAssetCard;
  }
}
