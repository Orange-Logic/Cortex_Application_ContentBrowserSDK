...
describe('Facet', () => {
  ...
  it('renders the facet with selected items', () => {
    const data = {
      type: 'example',
      values: [
        {
  ...
  it('renders the facet with loading state', () => {
    const data = {
      type: 'example',
      values: [
        {
  ...
  it('renders the facet with subtype', () => {
    const data = {
      type: 'example',
      values: [
        {
