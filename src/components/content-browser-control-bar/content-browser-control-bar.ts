...
import { ChangeOption, Facet, SortOrder } from '@/types/content-browser';
...
import CxContentBrowserControlFilter from '../content-browser-control-filter/content-browser-control-filter';
import CxContentBrowserControlSort from '../content-browser-control-sort/content-browser-control-sort';
import CxContentBrowserControlView from '../content-browser-control-view/content-browser-control-view';
import styles from './content-browser-control-bar.styles';
 ...
 *
 * @event cx-content-browser-control-bar-search-change - Fired when the search text is changed.
 */
@customElement('cx-content-browser-control-bar')
export default class CxContentBrowserControlBar extends CortexElement {
  ...
  static readonly dependencies = {
    ...
    'cx-content-browser-control-view': CxContentBrowserControlView,
    'cx-icon': CxIcon,
    'cx-input': CxInput,
  ...
  private handleSearchChange(event: CxChangeEvent) {
    ...
    this.emit('cx-content-browser-control-bar-search-change', {
      detail: {
      ...
      >
        ...
        <cx-space class="control-bar__right" direction="horizontal" spacing="x-small" wrap="nowrap" align-items="center">
          ...
          <cx-content-browser-control-view
            ...
            ?is-mobile=${this.isMobile}
          ></cx-content-browser-control-view>
          <cx-content-browser-control-sort
