...
import styles from './content-browser-control-view.styles';
 ...
 *
 * @event cx-content-browser-control-view-change - Emitted when the view mode or see-through mode is changed.
 */
@customElement('cx-content-browser-control-view')
export default class CxContentBrowserControlView extends CortexElement {
