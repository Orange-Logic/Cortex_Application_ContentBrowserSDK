...
import {
    customElement, getTabbableBoundary, LocalizeController, svgToDataUrl
} from '@orangelogic/design-system/utils';

import styles from './dam-view-browser.styles';
 ...
 */
@customElement('cx-dam-view-browser')
export default class CxDamViewBrowser extends CortexElement {
  ...
  @query('.dam-view-browser') drawer: CxDrawer;
