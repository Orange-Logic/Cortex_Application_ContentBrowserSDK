...
describe('VersionHistory', () => {
  ...
  it('renders version history items when data is loaded', () => {
    cy.mount(
      <Provider store={store}>
        <VersionHistory assetId="test-asset-id" />
      </Provider>,
  ...
  it('renders video elements when scrubUrl is present', () => {
  ...
  it('handles image orientation correctly', () => {
    cy.mount(
      <Provider store={store}>
        <VersionHistory assetId="test-asset-id" />
      </Provider>,
  ...
  it('does not make API call when assetId is not provided', () => {
    cy.mount(
      <Provider store={store}>
        <VersionHistory />
      </Provider>,
