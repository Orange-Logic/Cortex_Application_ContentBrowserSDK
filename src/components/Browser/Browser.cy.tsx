...
describe('Browser', () => {
  ...
  it('renders the browser with correct number of items', () => {
  ...
  it('selects default folder when localStorage data is invalid', () => {
  ...
  it('selects default folder when localStorage data is not found', () => {
    storeData(
      'lastLocation',
      JSON.stringify({
        id: 'some-random-id',
  ...
  it('selects correct folder when localStorage data is valid', () => {
    storeData(
      'lastLocation',
      JSON.stringify({
        id: '2Y1FQECIK0',
  ...
  it('renders default folder when lastLocationMode is false', () => {
    cy.mount(<BrowserWrapper lastLocationMode={false}></BrowserWrapper>);
    cy.get('cx-tree-item').should('have.length', folderData.length);
    cy.get('cx-tree-item').eq(0).should('have.attr', 'selected');
  });

  it('calls onFolderSelect when a folder is selected', () => {
