import './dam-view-control-filter-facet';

import { elementUpdated, expect, fixture, html } from '@open-wc/testing';

import type CxDamViewControlFilterFacet from './dam-view-control-filter-facet';

describe('dam-view-control-filter-facet', () => {
  let el: CxDamViewControlFilterFacet;

  beforeEach(async () => {
    el = await fixture(
      html`<cx-dam-view-control-filter-facet></cx-dam-view-control-filter-facet>`,
    );
  });
