...
import styles from './dam-view-asset-preview.styles';
...
@customElement('dam-view-asset-preview')
export default class CxDamViewAssetPreview extends CortexElement {
  ...
  private renderThumbnail() {
    if (this.inColdStorage) {
      return html`
        <div
          data-testid="dam-view-asset-preview__thumbnail--cold-storage"
          class=${classMap({
            'dam-view-asset-preview__thumbnail': true,
            'dam-view-asset-preview__thumbnail--other': true,
          })}>
          <cx-icon name="mode_cool" variant="filled"></cx-icon>
          <cx-typography data-testid="dam-view-asset-preview__thumbnail--cold-storage-text">
            ${this.localize.term('assetInColdStorage')}
          </cx-typography>
          <br />
          <cx-typography
            variant="small"
            data-testid="dam-view-asset-preview__thumbnail--cold-storage-text-small"
          >
    ...
    if (this.isError || !this.isUrlFilled) {
      return html`
        <div
          data-testid="dam-view-asset-preview__thumbnail--other"
          class=${classMap({
            'dam-view-asset-preview__thumbnail': true,
            'dam-view-asset-preview__thumbnail--other': true,
          })}
    ...
    if (this.docType === MediaType.Video) {
      return html`
        <cx-dam-view-asset-preview-video
          src=${this.scrubUrl}
    ...
    return html`
      <div
        data-testid="dam-view-asset-preview__representative-container"
        class=${classMap({
          'dam-view-asset-preview__representative-container': true,
          'dam-view-asset-preview__representative-container--animated': this.extension === GIF_EXTENSION && this.originalUrl && this.loaded,
        })}
      >
        <img
          class="dam-view-asset-preview__representative"
          src=${this.imageUrl}
          alt=${this.alt}
          ...
          () => html`
            <img
              class=${classMap({
                ...
                'dam-view-asset-preview__representative--animated': true,
              })}
      ...
      >
        ${when(
          ...
          () => html`
            <cx-skeleton
              slot="image"
              class="dam-view-asset-preview__skeleton"
            ></cx-skeleton>
          `,
        )}
