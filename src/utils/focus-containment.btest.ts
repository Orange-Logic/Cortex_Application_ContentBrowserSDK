...
import { findFocusContainmentHost } from './focus-containment';

function modal(className: string, extraStyle = ''): HTMLDivElement {
  const el = document.createElement('div');
  el.className = className;
  el.dataset.testModal = '';
  el.style.cssText =
...
describe('findFocusContainmentHost', () => {
  beforeEach(() => {
